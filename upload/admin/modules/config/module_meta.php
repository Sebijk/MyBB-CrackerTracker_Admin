...
function config_meta()
{
	...
	$sub_menu['160'] = array("id" => "ctracker", "title" => $lang->ctracker_system, "link" => "index.php?module=config/ctracker");
...
function config_action_handler($action)
{
	...
	$actions = array(
		...
		'ctracker' => array('active' => 'settings', 'file' => 'ctracker.php'),
	);
...
function config_admin_permissions()
{
	...
	$admin_permissions = array(
		...
		"ctracker" => $lang->can_manage_ctracker_tools,
	);
